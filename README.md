...
`fundpeek` 是一个命令行基金同步工具，用来把养基宝、小倍养基中的基金账户和持仓信息同步到 [基估宝](https://hzm0321.github.io/real-time-fund) 的云端配置中。它支持终端交互式登录、同步前自动备份、恢复备份，以及一个用于查看估值摘要的 TUI 界面。
